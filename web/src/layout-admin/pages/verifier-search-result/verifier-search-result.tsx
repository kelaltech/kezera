...
import { IAccountRequest, IAccountResponse } from '../../../../../api/modules/account/account.apiv'
...
function VerifierSearchResult(props: Props){
  ...
  let FetchVerifiers=function() {
    Axios.get('/api/account/search-verifiers' + qs.stringify({ term: qs.parse(window.location.search, {ignoreQueryPrefix:true}).term}, { addQueryPrefix: true }))
